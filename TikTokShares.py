...
if __name__ == "__main__":
    Clear()
    itemID = Write.Input(
        "Paste yout video link: ", Colors.light_green, interval=0.0001)
    amount = Write.Input("(0 is infinite) What amount of shares do you want: ", Colors.light_green, interval=0.0001)
    NThread = Write.Input("What amount of thread do you want: ", Colors.light_green, interval=0.0001)

    if Title("Starting!"):
        Debug = Write.Input("Debug Fails? [y/n]: ", Colors.purple, interval=0.0001)
